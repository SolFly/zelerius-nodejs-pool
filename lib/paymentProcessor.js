...
log('info', logSystem, 'Zelerius paymentProcessor.js v0.06');
...
function lrangeRedis(callback)
{
	...
	*
	* zelerius-testnet:REGISTER:addresses ZL38EUFVDYvCvrSexBuqgHMEKXZzR1TgR2XfuDtPikv1WpiifeLDqwfW7vXDUnv2zm7BFF6EVuve14j5iBNaCTyU2SHteq6M4:120:tu
	*
...
function ZeleriusPay(transferCommands, callback) {
  ...
  async.waterfall([
      ...
      //cmd is used to store data in redis database. See -> ZRANGE zelerius:payments:addres 0 -1
        ...
        log('info', logSystem, 'TX sent');
				...
				ZeleriusPay(transferCommands,callback);
    });
}//
        ...
        function(balances, minPayoutLevel, callback){
            ...
            callback(false,transferCommands);
				...
				function(command,callback){
					ZeleriusPay(command, function(error,result){
						log('info', logSystem, 'Zelerius Pay executed.');
